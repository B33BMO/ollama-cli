    ...
    properties: {
      ...
      baseUrl: {
        ...
        description: oneLine`
          ...
          Use this to connect to self-hosted Ollama instances (e.g., http://localhost:11434)
          or custom Ollama-compatible services.
          If not set, defaults to https://ollama.com.
        `,
        showInDialog: true,
      },
    },
