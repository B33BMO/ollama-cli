...
export function getCoreSystemPrompt(
  ...
  if (systemMdEnabled) {
    ...
    const promptConfig = {
      preamble: `You are Blackbox CLI, an interactive AI coding assistant powered by Ollama Cloud. You specialize in software engineering tasks. Your primary goal is to help users safely and efficiently, adhering strictly to the following instructions and utilizing your available tools.`,
      coreMandates: `
# Core Mandates
