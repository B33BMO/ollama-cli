...
> {
  ...
  constructor(
    ...
    super(
      ReadFileTool.Name,
      'ReadFile',
      `Reads file content. REQUIRED parameter: "file_path" (the path to the file). Optional: "offset" (start line), "limit" (max lines). Handles text, images (PNG, JPG, GIF, WEBP, SVG, BMP), and PDF files.`,
      Kind.Read,
      {
        properties: {
          file_path: {
