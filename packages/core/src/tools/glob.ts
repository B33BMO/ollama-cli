...
export class GlobTool extends BaseDeclarativeTool<GlobToolParams, ToolResult> {
  ...
  constructor(
    ...
    super(
      GlobTool.Name,
      'FindFiles',
      'Finds files matching glob patterns. REQUIRED parameter: "pattern" (e.g., "**/*.ts", "src/*.md"). Optional: "dir_path" (directory to search). Returns paths sorted by modification time (newest first).',
      Kind.Search,
      {
        properties: {
          pattern: {
