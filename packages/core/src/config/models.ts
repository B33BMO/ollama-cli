...
// Ollama Cloud models (no -cloud suffix for API, that's only for CLI)
// Using qwen3-coder which supports tool calling
export const DEFAULT_GEMINI_MODEL = 'qwen3-coder:480b';
export const DEFAULT_GEMINI_FLASH_MODEL = 'qwen3-coder:480b';
export const DEFAULT_GEMINI_FLASH_LITE_MODEL = 'qwen3-coder:480b';
